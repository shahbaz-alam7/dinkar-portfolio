    ...
    <main className="flex min-h-screen flex-col items-center justify-start p-24">
      <section className="text-center mb-16">
        ...
        <p className="max-w-2xl mx-auto text-lg">
          With over 2.5 years of experience, I specialize in building robust and
          scalable web applications using modern technologies. My expertise
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white/5 dark:bg-white/5 rounded-lg p-6 hover:bg-white/10 dark:hover:bg-white/10 transition-all duration-300">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              A platform enabling operators to make thousands of calls in
              minutes using advanced AI technology.
            </p>
            <a
              href="#projects"
              className="text-[#9333EA] dark:text-[#A855F7] hover:underline"
            >
              Learn more
            </a>
          </div>
          <div className="bg-white/5 dark:bg-white/5 rounded-lg p-6 hover:bg-white/10 dark:hover:bg-white/10 transition-all duration-300">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              A flight booking application with a responsive UI and backend APIs
              for booking and user management.
            </p>
            <a
              href="#projects"
              className="text-[#9333EA] dark:text-[#A855F7] hover:underline"
